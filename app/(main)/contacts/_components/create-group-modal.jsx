        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:ring-1 focus:ring-blue-500"
              {...register("name")}
            />
            {errors.name && (
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              ...
              {currentUser && (
                <Badge variant="secondary" className="px-3 py-1 bg-gray-800 text-gray-200">
              ...
              {selectedMembers.map((member) => (
                <Badge
                  key={member.id}
                  variant="secondary"
                  className="px-3 py-1 bg-gray-800 text-gray-200"
                >
                  <Avatar className="h-5 w-5 mr-2">
              ...
              <Popover open={commandOpen} onOpenChange={setCommandOpen}>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="h-8 gap-1 text-xs bg-gray-800 text-gray-200 border-gray-700 hover:bg-gray-700"
                  >
                      ...
                      <CommandGroup heading="Users" className="text-gray-400">
                        {searchResults?.map((user) => (
                          <CommandItem
                            ...
                            className="aria-selected:bg-gray-800 aria-selected:text-white"
                          >
