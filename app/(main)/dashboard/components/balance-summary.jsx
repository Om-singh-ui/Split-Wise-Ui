...
export function BalanceSummary({ balances }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {hasOwed && (
        <div>
          <h3 className="text-sm font-medium flex items-center text-green-500 mb-3">
          ...
          <div className="space-y-3 text-white">
            {oweDetails.youAreOwedBy.map((item) => (
              <Link
                ...
                key={item.userId}
                className="flex items-center justify-between hover:bg-gray-700/80 p-2 rounded-md transition-colors"
              >
